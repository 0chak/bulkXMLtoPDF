        ...
        <xsl:for-each select="$TipoFattura/FatturaElettronicaBody" >
          ...
          <xsl:choose>
            ...
            <xsl:otherwise>
              ...
              <!--  Dettaglio Linee   -->
              <table class="tbFoglio troppolargo" >

                <thead>
                  <tr>
                    <th width="50px">Cod.</th>
                    <th width="200px">Descrizione</th>
                    <th width="30px" class="import2" >Quantità</th>
                    <th width="60px" class="import2">Prezzo</th>
                    <th idth="20px" class="perc2">UM</th>
                    <th width="40px" class="perc">Sc.</th>
                    <th idth="40px" class="perc2">%IVA</th>
                    <th width="60px" class="ximport">Totale</th>
